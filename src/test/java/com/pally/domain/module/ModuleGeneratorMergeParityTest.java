...
class ModuleGeneratorMergeParityTest {
    ...
    void microCards_studentVsTeacherGuidance_identicalItemSet_andLiveStatus() {
        ...
        List<ModuleContentItem> student = gen.generateMicroCards("m1", "content", "P5", "Science", "FREE", "");
        List<ModuleContentItem> teacher = gen.generateMicroCards("m1", "content", "P5", "Science", "FREE", GUIDANCE);
    ...
    void spotMistake_studentVsTeacherGuidance_identicalItemSet() {
        ...
        List<ModuleContentItem> student = gen.generateSpotMistake("m1", "content", "P5", "Science", "");
        List<ModuleContentItem> teacher = gen.generateSpotMistake("m1", "content", "P5", "Science", GUIDANCE);
        assertSameStructure(student, teacher);
    ...
    void challenges_studentVsTeacherGuidance_identicalItemSet() {
        ...
        List<ModuleContentItem> student = gen.generateChallenges("m1", "content", "P5", "Science", "FREE", "");
        List<ModuleContentItem> teacher = gen.generateChallenges("m1", "content", "P5", "Science", "FREE", GUIDANCE);
        assertSameStructure(student, teacher);
